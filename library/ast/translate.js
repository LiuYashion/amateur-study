...
const options = process.argv.slice(2) // 截取参数
const { identifier: id, expressionStatement, memberExpression, assignmentExpression, arrowFunctionExpression, blockStatement } = recast.types.builders

// options 是node translate ... 后面跟的东西
